...
HD_PWD='E:/Bomberman/Bomberman-Vivado/Bomberman-Vivado.runs/numbers_dm_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log numbers_dm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source numbers_dm.tcl
